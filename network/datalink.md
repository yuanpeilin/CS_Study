# 数据链路层
* [概要](#user-content-概要-顶部)
* [局域网四个技术特性](#user-content-局域网四个技术特性-顶部)
* [点对点协议](#user-content-点对点协议-顶部)
* [CSMA/CD](#user-content-csmacd-顶部)
* [MAC](#user-content-mac-顶部)
* [交换机](#user-content-交换机-顶部)

***************************************************************************

# 概要 [顶部](#user-content-数据链路层)
### 数据链路层使用的信道
...
# 局域网四个技术特性 [顶部](#user-content-数据链路层)
* **传输媒体** 双绞线, 同轴电缆
* **传输技术** 基带传输(局域网), 宽带传输
* **网络拓扑** 星型, 总线型, 环型, 数型
* **媒体访问控制方法** 信道划分, 轮询, 随机访问 

# 点对点协议 [顶部](#user-content-数据链路层)
### 帧格式
